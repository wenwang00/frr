...
static void zebra_nhg_pic_dependents_del(struct nhg_hash_entry *from,
				     struct nhg_hash_entry *pic_nh)
{
	nhg_connected_tree_del_nhe(&from->picnh_dependents, pic_nh);
}

static void zebra_nhg_pic_dependents_add(struct nhg_hash_entry *to,
				     struct nhg_hash_entry *pic_nh)
{
